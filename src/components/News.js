...
export class News extends Component {
  ...
  static propTypes = {
    ...
    category: PropTypes.string, //not necessary to define types of props
  }
  ...
  //Constructor is a function which runs at the first when any file(News.js) runs
  constructor(props) {
    super(props);
    this.state = {
      articles: [],
  ...
  //This starts our functions at the very starting
  ...
  //This is for infinte scrolling which needs more data at the end of the page
  fetchMoreData = async () => {
    this.setState({ page: this.state.page + 1 })
    const url = `https://newsapi.org/v2/top-headlines?country=${this.props.country}&category=${this.props.category}&apiKey=d093053d72bc40248998159804e0e67d&page=${this.state.page}&pageSize=${this.props.pageSize}`;
    let data = await fetch(url);
